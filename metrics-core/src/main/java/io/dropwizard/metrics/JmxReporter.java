...
public class JmxReporter implements Reporter, Closeable {
    ...
    private static class JmxHistogram implements JmxHistogramMBean {
        ...
        public double get90thPercentile() {
            return metric.getSnapshot().get90thPercentile();
        }
    ...
    static class JmxTimer extends JmxMeter implements JmxTimerMBean {
        ...
        @Override
        public double get90thPercentile() {
            return metric.getSnapshot().get90thPercentile() * durationFactor;
        }

        @Override
        public double get95thPercentile() { return metric.getSnapshot().get95thPercentile() * durationFactor; }
