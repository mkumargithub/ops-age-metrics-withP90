...
public class JmxReporterTest {
    ...
    public void setUp() throws Exception {
        ...
        when(hSnapshot.get90thPercentile()).thenReturn(8.0);
        when(hSnapshot.get95thPercentile()).thenReturn(9.0);
        when(hSnapshot.get98thPercentile()).thenReturn(10.0);
        when(hSnapshot.get99thPercentile()).thenReturn(11.0);
        when(hSnapshot.get999thPercentile()).thenReturn(12.0);
        ...
        when(tSnapshot.get90thPercentile()).thenReturn((double) TimeUnit.MILLISECONDS.toNanos(700));
        when(tSnapshot.get95thPercentile()).thenReturn((double) TimeUnit.MILLISECONDS.toNanos(800));
        when(tSnapshot.get98thPercentile()).thenReturn((double) TimeUnit.MILLISECONDS.toNanos(900));
        when(tSnapshot.get99thPercentile()).thenReturn((double) TimeUnit.MILLISECONDS.toNanos(1000));
        when(tSnapshot.get999thPercentile()).thenReturn((double) TimeUnit.MILLISECONDS.toNanos(1100));
    ...
    public void registersMBeansForHistograms() throws Exception {
        ...
        assertThat(values(attributes))
                ...
                .contains(entry("90thPercentile", 8.0))
                .contains(entry("95thPercentile", 9.0))
                .contains(entry("98thPercentile", 10.0))
                .contains(entry("99thPercentile", 11.0))
                .contains(entry("999thPercentile", 12.0));
    }
    ...
    public void registersMBeansForTimers() throws Exception {
        ...
        assertThat(values(attributes))
                ...
                .contains(entry("90thPercentile", 700.0))
                .contains(entry("95thPercentile", 800.0))
                .contains(entry("98thPercentile", 900.0))
                .contains(entry("99thPercentile", 1000.0))
                .contains(entry("999thPercentile", 1100.0))
                .contains(entry("RateUnit", "events/second"))
