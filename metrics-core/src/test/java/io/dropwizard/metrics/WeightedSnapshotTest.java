...
public class WeightedSnapshotTest {
    ...
    static public ArrayList<WeightedSnapshot.WeightedSample> WeightedArray(long[] values, double[] weights) {
        if (values.length != weights.length) {
            throw new IllegalArgumentException("Mismatched lengths: " + values.length + " vs " + weights.length);
        }
        
        final ArrayList<WeightedSnapshot.WeightedSample> samples = new ArrayList<WeightedSnapshot.WeightedSample>();
